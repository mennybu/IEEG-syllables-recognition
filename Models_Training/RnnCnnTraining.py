...
if __name__ == "__main__":
    data_dir = r'/home/tauproj6/final_runs_EEG_proj/patient_1_output_1.5s_pca_2syl/annotate/'
    label_to_idx = {'a': 0, 'e': 1, 'i': 2, 'o': 3, 'u': 4}

    model_dir = f'/home/tauproj6/final_runs_EEG_proj/patient_1_output_1.5s_pca_2syl/other_model_1_10_2rnn_18cnn'
    ...
    scheduler = ReduceLROnPlateau(optimizer, mode='min', factor=0.5, patience=40, verbose=True, min_lr=5e-5)

...
if __name__ == "__main__":
    ...
    val_data_dir = r'/home/tauproj6/EEG_proj/patient_1_output/annotate_validation'
    ...
    for epoch in range(10,310,10):
        model.load_state_dict(torch.load(rf'/home/tauproj6/EEG_proj/patient_1_output/annotate_model_2layer/trained_model_ANNOTATE_epoch_{epoch}.pth'))
        model.eval()

...
if __name__ == "__main__":
    ...
    val_data_dir = r'/home/tauproj6/EEG_proj/patient_1_output_3s_v2/annotate_validation'
    label_to_idx = {'a': 0, 'e': 1, 'i': 2, 'o': 3, 'u': 4}
    idx_to_label = {v: k for k, v in label_to_idx.items()}
    # Create validation dataset instance
    val_dataset = main_code_2layers_cnn.EEGDataset(val_data_dir, label_to_idx)
    ...
    model = main_code_2layers_cnn.CnnRnnClassifier(**model_settings)
    ...
    models_dir = f'/home/tauproj6/EEG_proj/patient_1_output_3s_v2/annotate_2layers_cnn_model_3layer_0.7do_01_07_lr0.0005/'
    ...
    # Unpack the data
    epochs, val_loss, val_accuracy = data['Epoch'], data['Loss'], data['Accuracy']

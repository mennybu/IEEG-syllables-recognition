...
import time
import main_code_post_cnn_separated
import numpy as np
...
if __name__ == "__main__":
    ...
    val_data_dir = r'/home/tauproj6/EEG_proj/patient_1_output_3s_separated/annotate_validation'
    label_to_idx = {'a': 0, 'e': 1, 'i': 2, 'o': 3, 'u': 4}
    idx_to_label = {v: k for k, v in label_to_idx.items()}
    # Create validation dataset instance
    val_dataset = main_code_post_cnn_separated.EEGDataset(val_data_dir, label_to_idx)
    ...
    model = main_code_post_cnn_separated.CnnRnnClassifier(**model_settings)
    ...
    models_dir = r"/home/tauproj6/EEG_proj/patient_1_output_3s_separated/annotate_model_keeptime_3layer_0.7do_08_07_lr0.001_80cnn_separated/"

...
import time
import transformer_model_trainig
import numpy as np
...
if __name__ == "__main__":
    ...
    val_data_dir = r'/home/tauproj6/EEG_proj//patient_1_1s_preproccesed_steeper/annotate_validation'
    label_to_idx = {'a': 0, 'e': 1, 'i': 2, 'o': 3, 'u': 4}
    idx_to_label = {v: k for k, v in label_to_idx.items()}
    # Create validation dataset instance
    val_dataset = transformer_model_trainig.EEGDataset(val_data_dir, label_to_idx)
    ...
    model = transformer_model_trainig.TransformerWithFF(**model_settings)
    ...
    models_dir = r"/home/tauproj6/EEG_proj/patient_1_1s_preproccesed_steeper/annotate_model_03.08_Transformer_less_ff/"

...
if __name__ == "__main__":
    ...
    val_dataset = main_code_post_cnn_4s.EEGDataset(val_data_dir, label_to_idx)
    ...
    model = main_code_post_cnn_4s.CnnRnnClassifier(**model_settings)
    ...
    models_dir = r"/home/tauproj6/EEG_proj/patient_1_output_4s/annotate_model_keeptime_3layer_0.7do_09_07_lr0.001_80cnn/"

...
if __name__ == "__main__":
    data_dir = r'/home/tauproj6/final_runs_EEG_proj/patient_1_output_1.5s_pca_2syl/imagery/'
    label_to_idx = {'a': 0, 'i': 1}

    model_dir = f'/home/tauproj6/final_runs_EEG_proj/patient_1_output_1.5s_pca_2syl/imagery_model_4_10_1rnn_15cnn'
    ...
    scheduler = ReduceLROnPlateau(optimizer, mode='min', factor=0.5, patience=30, verbose=True, min_lr=5e-5)

...
def save_parameters_to_file(params, lr, tw, filename):
...
#number of samples from the final tensor after post_cnn
t_samples = 10
...
if __name__ == "__main__":
    ...
    data_dir = r'/home/tauproj6/EEG_proj/patient_1_output_4s/annotate'

    label_to_idx = {'a': 0, 'e': 1, 'i': 2, 'o': 3, 'u': 4}

    # Define the directory where you want to save the model
    model_dir = f'/home/tauproj6/EEG_proj/patient_1_output_4s/annotate_model_keeptime_3layer_0.7do_09_07_lr0.001_80cnn/'

...
if __name__ == "__main__":
    ...
    val_dataset = rnn_than_cnn_script.EEGDataset(val_data_dir, label_to_idx)
    ...
    model = rnn_than_cnn_script.RnnCnnClassifier(**model_settings)
    ...
    models_dir = r"/home/tauproj6/EEG_proj/patient_1_output_1.5s/annotate_model_rnn_than_cnn/"

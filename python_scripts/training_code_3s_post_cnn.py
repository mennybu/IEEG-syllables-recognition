...
if __name__ == "__main__":
    ...
    val_dataset = main_code_post_cnn.EEGDataset(val_data_dir, label_to_idx)
    ...
    model = main_code_post_cnn.CnnRnnClassifier(**model_settings)
    ...
    models_dir = r"/home/tauproj6/EEG_proj/patient_1_output_3s_v2/annotate_model_keeptime_3layer_0.7do_07_07_lr0.001_80cnn/"
    ...
    for epoch in range(10, 4010, 50):
        ...
        if Path(model_path).exists():
            ...
            print(f'\nTraining Loss: {val_epoch_loss:.4f}, Training Accuracy: {val_epoch_accuracy:.4f} for epoch model num {epoch}')

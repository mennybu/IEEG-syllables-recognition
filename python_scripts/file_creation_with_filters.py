...
def main():
    ...
    for event in event_data:
        ...
        output_dir = rf"/home/tauproj6/EEG_proj/patient_1_output_1.5s_preproccesed/{label_to_info[label][1]}/{label_to_info[label][0]}"
    ...
    with open(fr"/home/tauproj6/EEG_proj/audio_times - training only_with_changes.log") as file:
        ...
        while line:
            ...
            if "BEEP" in line or "IMAGERY" in line:
                ...
                if next_line and (int(next_line.split()[1]) - event_time_start) / 1.5e6 < 1:
                    event_time_end = int(next_line.split()[1])
                else:
                    event_time_end = event_time_start + 1 * 1.5e6

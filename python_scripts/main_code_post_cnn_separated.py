...
class CnnRnnClassifier(torch.nn.Module):
    ...
    def __init__(self, rnn_dim, KS, num_layers, dropout, n_classes, bidirectional, in_channels, keeptime=False,
        ...
        self.dense = nn.Linear(rnn_dim * mult*30, n_classes)
...
if __name__ == "__main__":
    ...
    data_dir = r'/home/tauproj6/EEG_proj/patient_1_output_3s_separated/annotate'

    label_to_idx = {'a': 0, 'e': 1, 'i': 2, 'o': 3, 'u': 4}

    # Define the directory where you want to save the model
    model_dir = f'/home/tauproj6/EEG_proj/patient_1_output_3s_separated/annotate_model_keeptime_3layer_0.7do_08_07_lr0.001_80cnn_separated/'

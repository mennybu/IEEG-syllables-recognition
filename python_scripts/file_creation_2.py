...
def load_all_eeg_data():
    ...
    for electrode_num in range(1, 127):
        ...
        eeg_file_path = rf"C:\Users\amhec\Downloads\For_Meni_and_Ezra\CSC{electrode_num}.mat"
...
def main():
    ...
    for event in event_data:
        ...
        output_dir = rf"C:\EEG_project_2.0\{label_to_info[label][1]}\{label_to_info[label][0]}"
...
if __name__ == "__main__":
    ...
    with open(fr"C:\EEG_project_2.0\audio_times - training only_with_changes.log") as file:
        ...
        while line:
            ...
            if "BEEP" in line or "IMAGERY" in line:
                ...
                if next_line and (int(next_line.split()[1]) - event_time_start)/1e6 < 5:
                    event_time_end = int(next_line.split()[1])
                else:
                    event_time_end = event_time_start + 5e6

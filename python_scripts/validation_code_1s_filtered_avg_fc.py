...
import time
import main_code_post_cnn_1s_avg_fc
import numpy as np
...
if __name__ == "__main__":
    ...
    val_data_dir = r'/home/tauproj6/EEG_proj/patient_1_1s_preproccesed_steeper_pca_sep/annotate_validation'
    label_to_idx = {'a': 0, 'e': 1, 'i': 2, 'o': 3, 'u': 4}
    idx_to_label = {v: k for k, v in label_to_idx.items()}
    # Create validation dataset instance
    val_dataset = main_code_post_cnn_1s_avg_fc.EEGDataset(val_data_dir, label_to_idx)
    ...
    model = main_code_post_cnn_1s_avg_fc.CnnRnnClassifier(**model_settings)
    ...
    models_dir = r"/home/tauproj6/EEG_proj/patient_1_1s_preproccesed_steeper_pca_sep/annotate_model_03.08_CnnRnn_post_cnn_20cnn_mean_pool_5_samples/"

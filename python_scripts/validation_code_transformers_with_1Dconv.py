...
if __name__ == "__main__":
    ...
    val_data_dir = r'/home/tauproj6/EEG_proj/patient_1_output_1.5s/annotate_validation'
    label_to_idx = {'a': 0, 'e': 1, 'i': 2, 'o': 3, 'u': 4}
    idx_to_label = {v: k for k, v in label_to_idx.items()}
    # Create validation dataset instance
    val_dataset = transformer_model_code.EEGDataset(val_data_dir, label_to_idx)
    ...
    model = transformer_model_code.TransformerWithSepChannels1DConv(**model_settings)
    ...
    models_dir = r"/home/tauproj6/EEG_proj/patient_1_output_1.5s/annotate_model_25.07_transformer_with_sep_conv1D/"

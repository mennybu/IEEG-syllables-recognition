...
if __name__ == "__main__":
    ...
    data_dir = r'/home/tauproj6/EEG_proj/patient_1_output_3s_test_avg/annotate'

    label_to_idx = {'a': 0, 'e': 1, 'i': 2, 'o': 3, 'u': 4}

    # Define the directory where you want to save the model
    model_dir = f'/home/tauproj6/EEG_proj/patient_1_output_3s_test_avg/annotate_model_2layer/'

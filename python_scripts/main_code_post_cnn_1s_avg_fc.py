...
def save_parameters_to_file(params, lr, filename):
    with open(filename, 'w') as file:
        ...
        file.write('\nModel name: CnnRnnmodel with post cnn and mean pooling\n')
        file.write(f'\nt_samples: {t_samples}\n')
...
if __name__ == "__main__":
    data_dir = r'/home/tauproj6/EEG_proj/patient_1_1s_preproccesed_steeper_pca_sep/annotate'
    label_to_idx = {'a': 0, 'e': 1, 'i': 2, 'o': 3, 'u': 4}

    model_dir = f'/home/tauproj6/EEG_proj/patient_1_1s_preproccesed_steeper_pca_sep/annotate_model_03.08_CnnRnn_post_cnn_20cnn_mean_pool_5_samples/'
    ...
    scheduler = ReduceLROnPlateau(optimizer, mode='min', factor=0.5, patience=10, verbose=True, min_lr=5e-5)

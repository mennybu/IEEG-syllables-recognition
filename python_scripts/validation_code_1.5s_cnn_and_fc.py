...
if __name__ == "__main__":
    ...
    val_dataset = only_cnn_and_fc.EEGDataset(val_data_dir, label_to_idx)
    ...
    model = only_cnn_and_fc.SeparateConv1DClassifier(**model_settings)
    ...
    models_dir = r"/home/tauproj6/EEG_proj/patient_1_output_1.5s/annotate_model_19.07_seperate_conv1D/"

...
import time
import main_code_post_cnn_15s_meanpool
import numpy as np
...
if __name__ == "__main__":
    ...
    val_data_dir = r'/home/tauproj6/EEG_proj/patient_1_output_1.5s_pca_2syls/annotate_validation'
    label_to_idx = {'a': 0, 'e': 1, 'i': 2, 'o': 3, 'u': 4}
    idx_to_label = {v: k for k, v in label_to_idx.items()}
    # Create validation dataset instance
    val_dataset = main_code_post_cnn_15s_meanpool.EEGDataset(val_data_dir, label_to_idx)
    ...
    model = main_code_post_cnn_15s_meanpool.CnnRnnClassifier(**model_settings)
    ...
    models_dir = r"/home/tauproj6/EEG_proj/patient_1_output_1.5s_pca_2syls/annotate_model_05.08_CnnRnn_post_cnn_25cnn_mean_pool/"

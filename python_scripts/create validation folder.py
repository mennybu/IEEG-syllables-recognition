...
def perform_pca_and_save(input_dir, output_dir):
    ...
    n_components = torch.sum(cumulative_variance_ratio < 0.985).item() + 1
    ...
    print("Number of components to retain 98.5% variance:", n_components)
...
directory_pairs = [
    ('/path/to/first/input_dir', '/path/to/first/output_dir'),
    ('/path/to/second/input_dir', '/path/to/second/output_dir'),
    ('/path/to/third/input_dir', '/path/to/third/output_dir')
]

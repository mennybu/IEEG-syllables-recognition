...
if __name__ == "__main__":
    ...
    val_data_dir = r'/home/tauproj6/final_runs_EEG_proj/patient_1_output_1.5s_pca_2syl/other_validation/'#'/home/tauproj6/EEG_proj/patient_1_output_1.5s_pca_v2/annotate_validation'
    label_to_idx = {'a': 0, 'i': 1}
    idx_to_label = {v: k for k, v in label_to_idx.items()}
    # Create validation dataset instance
    val_dataset = main_code_post_cnn_15s.EEGDataset(val_data_dir, label_to_idx)
    ...
    model = main_code_post_cnn_15s.CnnRnnClassifier(**model_settings)
    ...
    models_dir = f'/home/tauproj6/final_runs_EEG_proj/patient_1_output_1.5s_pca_2syl/other_model_4_10_2rnn_15cnn'#"/home/tauproj6/EEG_proj/patient_1_output_1.5s_pca_v2/annotate_model_26.07_pca/"
    ...
    ax2.axhline(y=0.2, color='darkblue', linestyle='--', label=f'Chance Accuracy For 5 Vowels: 0.2')
